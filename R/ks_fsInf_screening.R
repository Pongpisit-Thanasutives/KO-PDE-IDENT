...
X_path <- "../Cache/X_pre_ks_noise50_sample2000.npy"
y_path <- "../Cache/y_pre_ks_noise50_sample2000.npy"
...
save_file = "./R_data/fsInf_active_ks_noise50_sample2000_alpha10.rds"
